...
import net.mcreator.creativeworld.procedures.JetpackSpcaeUnpressEventProcedure;
import net.mcreator.creativeworld.procedures.JetpackSpcaePressEventProcedure;
...
public record ElectricjetpackcontrolMessage(int eventType, int pressedms) implements CustomPacketPayload {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			JetpackSpcaePressEventProcedure.execute(entity);
		}
		if (type == 1) {

			JetpackSpcaeUnpressEventProcedure.execute(entity);
		}
	}
