...
public class FdgdfMenu extends AbstractContainerMenu {
	...
	public FdgdfMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
	...
	public FdgdfMenu(int id, Inventory inv, Container container) {
		super(CreativeWorldModMenus.FDGDF, id);
