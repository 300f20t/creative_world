...
public class MsrpmroMenu extends AbstractContainerMenu {
	...
	public MsrpmroMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
	...
	public MsrpmroMenu(int id, Inventory inv, Container container) {
