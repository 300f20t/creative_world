...
public class MediumgasmineFeature extends Feature<NoneFeatureConfiguration> {
	public static MediumgasmineFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new MediumgasmineFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("creative_world:mediumgasmine", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("creative_world:mediumgasmine", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("creative_world", "medium_gas_mine"));
		if (template == null)
			return false;
