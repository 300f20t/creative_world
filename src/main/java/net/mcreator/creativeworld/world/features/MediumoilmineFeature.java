...
public class MediumoilmineFeature extends Feature<NoneFeatureConfiguration> {
	public static MediumoilmineFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new MediumoilmineFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("creative_world:mediumoilmine", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("creative_world:mediumoilmine", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("creative_world", "medium_oil_mine"));
		if (template == null)
			return false;
