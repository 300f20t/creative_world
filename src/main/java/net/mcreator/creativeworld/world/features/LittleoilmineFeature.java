...
public class LittleoilmineFeature extends Feature<NoneFeatureConfiguration> {
	public static LittleoilmineFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new LittleoilmineFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("creative_world:littleoilmine", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("creative_world:littleoilmine", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("creative_world", "little_oil_mine"));
		if (template == null)
			return false;
