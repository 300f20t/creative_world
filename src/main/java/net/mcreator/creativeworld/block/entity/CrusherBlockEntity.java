...
public class CrusherBlockEntity extends RandomizableContainerBlockEntity implements ExtendedScreenHandlerFactory, WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);

	public CrusherBlockEntity(BlockPos position, BlockState state) {
		super(CreativeWorldModBlockEntities.CRUSHER, position, state);
	}
