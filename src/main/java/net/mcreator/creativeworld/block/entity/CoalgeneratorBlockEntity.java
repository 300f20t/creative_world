...
public class CoalgeneratorBlockEntity extends RandomizableContainerBlockEntity implements ExtendedScreenHandlerFactory, WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);

	public CoalgeneratorBlockEntity(BlockPos position, BlockState state) {
		super(CreativeWorldModBlockEntities.COALGENERATOR, position, state);
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new FgfhffhghkjkkytwqaMenu(id, inventory, this);
	}
