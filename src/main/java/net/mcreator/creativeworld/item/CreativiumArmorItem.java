...
public abstract class CreativiumArmorItem extends ArmorItem {
	public CreativiumArmorItem(Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public int getDefenseForType(Type type) {
				return new int[]{24, 32, 32, 24}[type.getSlot().getIndex()];
			}
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(CreativeWorldModItems.CREATIVIUM_INGOT));
			}
