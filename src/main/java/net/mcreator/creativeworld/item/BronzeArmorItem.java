...
public abstract class BronzeArmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 11, BuiltInRegistries.SOUND_EVENT.wrapAsHolder(SoundEvents.EMPTY), () -> Ingredient.of(new ItemStack(CreativeWorldModItems.BRONZE_INGOT.get())), List.of(new ArmorMaterial.Layer(ResourceLocation.parse("creative_world:bronze"))), 0f,
					0f);
			registerHelper.register(ResourceLocation.parse("creative_world:bronze_armor"), armorMaterial);
