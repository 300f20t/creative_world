...
public abstract class TinArmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 7, BuiltInRegistries.SOUND_EVENT.wrapAsHolder(SoundEvents.EMPTY), () -> Ingredient.of(new ItemStack(CreativeWorldModItems.TIN_INGOT.get())), List.of(new ArmorMaterial.Layer(ResourceLocation.parse("creative_world:tin_"))), 0f, 0.1f);
			registerHelper.register(ResourceLocation.parse("creative_world:tin_armor"), armorMaterial);
